...
export function LoanSummaryCard({ maxLoanLimit, availableToBorrow }: LoanSummaryCardProps) {
  return (
    <div className="relative p-6 rounded-2xl text-white bg-gradient-to-br from-purple-500 to-pink-500 shadow-lg flex flex-col justify-between min-h-[180px]">
      <div className="absolute top-4 right-4 h-8 w-8 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
